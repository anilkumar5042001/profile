...
urlpatterns = [
    ...
    url(r'^CountryGetAll/', views.CountryGetAll),
    ...
    url(r'^WorkHistoryGetCurrentlyWorkingItem/', WorkHistoryView.WorkHistoryGetCurrentlyWorkingItem),
    url(r'^GetWorkHistoryByProfileIdAndCompanyId/', WorkHistoryView.GetWorkHistoryByProfileIdAndCompanyId),
    ...
    url(r'^GetAwardsByAssignToAndCompanyDomain/', AwardsView.GetAwardsByAssignToAndCompanyDomain),
